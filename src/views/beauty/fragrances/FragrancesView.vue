<template>
  ...
  >
    <div class='fragrances h-100'>
      ...
      <div
        v-else
        class='fragrances__content pa-3'
      >
        <ProductCardBase
...
const fetchData = () => productsStore.fetchData(paginateFilter.value, productsUrls.PRODUCTS_CATEGORIES_FRAGRANCES_URL)
